...
router.put('/story', auth.verifyJWT, StoryController.updateStory)
router.delete('/story/:id', auth.verifyJWT, StoryController.deleteStory)
router.get('/storiesbygenres', auth.verifyJWT, StoryController.getStoriesByGenre)
...
router.put('/storychapter', auth.verifyJWT, StoryController.updateStoryChapter)
router.delete('/storychapter/:id', auth.verifyJWT, StoryController.deleteStoryChapter)
router.get('/storychapter/:id', auth.verifyJWT, StoryController.getStoryChapterById)
